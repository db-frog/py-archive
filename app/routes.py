...
@router.get("/folderContents", response_description="Get the name of folders or entries in the current folder path specified by query parameter", response_model=List[
    Union[str, FolkloreCollection]])
